# Npool review middleware

[![Test](https://github.com/NpoolPlatform/review-middleware/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/review-middleware/actions/workflows/main.yml)
...
* make review-middleware ```单独编译服务```
* make review-middleware-image ```单独生成服务镜像```
